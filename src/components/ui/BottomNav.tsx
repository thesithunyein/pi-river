...
export function BottomNav() {
  ...
  return (
    <nav className="pointer-events-none fixed inset-x-0 bottom-0 z-40 px-3 pb-[calc(env(safe-area-inset-bottom)+0.55rem)] pt-2">
      <div className="pointer-events-auto mx-auto flex w-full max-w-lg items-center gap-1 rounded-[28px] border border-white/10 bg-[#12101c]/92 p-1.5 shadow-[0_18px_50px_rgba(0,0,0,0.45)] backdrop-blur-xl sm:max-w-xl">
        {items.map((item) => {
